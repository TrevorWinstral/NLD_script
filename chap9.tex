...
\begin{ex}[]
	...
	\begin{align}
		m_1(-1) \neq - \sqrt{24}:\quad \forall m_1\in\mathbb{N}^{+}.
	\end{align}
	...
	\begin{figure}[h!]
		\centering
		%\includegraphics[width=\textwidth]{}
		\caption{A projection of the extended phase space, the teal surface is the unique, analytic, quasiperiodic spectral submanifold, emanating from the unique quasiperiodic nonlinear normal mode in red.}
		\label{fig:ssm_ex2}
	\end{figure}	
\end{ex}
